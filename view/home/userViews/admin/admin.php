...
<section class="d-flex">
    ...
    <div id="signatures"class="m-auto admin-section white rounded-3 col-8 d-flex flex-column mt-4 d-none"><?php require_once("view/home/userViews/admin/partials/signatures.php")?></div>
</section>
