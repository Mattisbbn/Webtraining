...
<div id="accounts" class="admin-section gray rounded-3 col-8 d-flex flex-column mt-4"><?php require_once("view/admin/partials/accounts.php")?></div>
<div id="classes" class="admin-section gray rounded-3 col-8 d-flex flex-column mt-4 d-none"><?php require_once("view/admin/partials/classes.php")?></div>
<div id="lessons" class="admin-section gray rounded-3 col-8 d-flex flex-column mt-4 d-none"><?php require_once("view/admin/partials/lessons.php")?></div>
<div id="subjects" class="admin-section gray rounded-3 col-8 d-flex flex-column mt-4 d-none"><?php require_once("view/admin/partials/subjects.php")?></div>
