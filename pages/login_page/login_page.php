<section id="login_section" class="d-flex justify-content-center align-items-center">
    ...
    <div class="col-lg-4 col-md-8  col-10" id="login_form_header">
    ...
    <div class=" col-lg-4 col-md-8  col-10" id="login_form_container">
        <div id="login_choice">
            ...
            <div>
                <button class="login_buttons" id="animator_button">
                    <p>Animateur</p>
                </button>
             
                <button class="login_buttons" id="admin_button">
                    <p>Administrateur</p>
                </button>
            </div>
            <div>
            <button class="login_buttons" id="student_button">
                    <p>Étudiant</p>
                </button>
